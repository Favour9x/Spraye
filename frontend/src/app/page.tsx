  ...
  return (
    <div className="min-h-screen bg-[#0A0A0A]">
      ...
      <section className="relative overflow-hidden">
        {/* Background gradient */}
        <div className="absolute inset-0 bg-gradient-to-br from-[#0052FF]/10 via-transparent to-transparent" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="relative">
              <div className="bg-black border border-gray-800 rounded-xl p-8 hover:border-[#0052FF]/50 transition-all">
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Feature 1 */}
            <div className="bg-black border border-gray-800 rounded-xl p-6 hover:border-[#0052FF]/50 transition-all">
      ...
      {/* CTA Section */}
      <section className="py-20 bg-gradient-to-br from-[#0052FF]/10 via-transparent to-transparent">
